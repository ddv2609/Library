          ...
          <Row align="top" justify="center">
            <Col md={24} lg={10} xl={10}>
              <div className={styles.about}>
                ...
                <p className={styles.paragraph}>Welcome to our online bookstore, where the joy of reading comes alive! We are delighted to present to you a vast collection of books from various genres, catering to every literary taste and interest. Whether you're a passionate bookworm, a knowledge seeker, or a casual reader, our website is designed to be your ultimate destination for all things books.</p>
              </div>
